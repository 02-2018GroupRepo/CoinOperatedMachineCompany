...
public class DrinkMachine extends Vending_Machine {
    public DrinkMachine(){
        ...
        Products pepsi      = new Products(1, "pepsi", "pepsi    ", 0.0, 0.0);
        Products coke       = new Products(2, "coke", "coke     ", 0.0, 0.0);
        Products sprite     = new Products(3, "sprite", "sprite   ", 0.0, 0.0);
        Products fanta      = new Products(4, "fanta", "fanta    ", 0.0, 0.0);
        Products dr         = new Products(5, "dr", "dr       ", 0.0, 0.0);
        Products pepper     = new Products(6, "pepper", "pepper   ", 0.0, 0.0);
        Products mountian   = new Products(7, "mountian", "mountian ", 0.0, 0.0);
        Products dew        = new Products(8, "dew", "dew      ", 0.0, 0.0);
        Products brisk      = new Products(9, "brisk", "brisk    ", 0.0, 0.0);
        Products iceT       = new Products(10, "iceT", "iceT     ", 0.0, 0.0);
        Products coffee     = new Products(11, "coffee", "coffee   ", 0.0, 0.0);
        Products budlight   = new Products(12, "budlight", "budlight ", 0.0, 0.0);
        Products miller     = new Products(13, "miller", "miller   ", 0.0, 0.0);
        Products amstel     = new Products(14, "amstel", "amstel   ", 0.0, 0.0);
        Products icehouse   = new Products(15, "icehouse", "icehouse ", 0.0, 0.0);
        Products budweiser  = new Products(16, "budweiser", "budweiser", 0.0, 0.0);
        Products guiness    = new Products(17, "guiness", "guiness  ", 0.0, 0.0);
        Products corona     = new Products(18, "corona", "corona   ", 0.0, 0.0);
